...
export class FocusPage {
  ...
  download() {
    ...
    const url = 'https://github.com/mirza339/dreamRings/raw/master/music_src/focus.mp3';
    this.downloading = true;
    fileTransfer.download(url, this.file.dataDirectory + '/music/focus.mp3').then((entry) => {
      console.log('download complete: ' + entry.toURL());
      this.downloadLink = entry.toURL();
      localStorage.setItem('focus', this.downloadLink);
  ...
  checkDownloads() {
    const dreamLink = localStorage.getItem('focus');
