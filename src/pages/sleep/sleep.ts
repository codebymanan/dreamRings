...
export class SleepPage {
  ...
  download() {
    ...
    const url = 'https://github.com/mirza339/dreamRings/raw/master/music_src/sleep.mp3';
    this.downloading = true;
    fileTransfer.download(url, this.file.dataDirectory + '/music/sleep.mp3').then((entry) => {
      console.log('download complete: ' + entry.toURL());
      this.downloadLink = entry.toURL();
      localStorage.setItem('sleep', this.downloadLink);
  ...
  checkDownloads() {
    const dreamLink = localStorage.getItem('sleep');
