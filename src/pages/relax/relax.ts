...
export class RelaxPage {
  ...
  download() {
    ...
    const url = 'https://github.com/mirza339/dreamRings/raw/master/music_src/relax.mp3';
    this.downloading = true;
    fileTransfer.download(url, this.file.dataDirectory + '/music/relax.mp3').then((entry) => {
      console.log('download complete: ' + entry.toURL());
      this.downloadLink = entry.toURL();
      localStorage.setItem('relax', this.downloadLink);
  ...
  checkDownloads() {
    const dreamLink = localStorage.getItem('relax');
